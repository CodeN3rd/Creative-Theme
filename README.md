# Creative Responsive Website Template
A Creative template setup for new clients who want a basic information website from FAI Marketing Inc.

## Setup Creative ##
_Here are the steps to install Creative on Clients Server_
```
1) Setup Ubuntu Server
2) Install Apache2
3) Install PhP
4) Obtain SSL Certification
5) Alter Creative Theme Wordage & Images for Client Needs
